...
begin
  try
    ...
    begin
      ...
      Nomebtn := qyModulos.FieldByName('DESC_CATEGORIA').AsString+'item'+qyModulos.FieldByName('ID_CATEGORIA').AsString;

      CriarBtn(CaptionBtn, Nomebtn, ScrollItens, CliqueAbrirForm);
    ...
    btnVoltarMenu.Tag := TButton(Sender).Tag;
    qyModulos.Close;
  end;
end;
